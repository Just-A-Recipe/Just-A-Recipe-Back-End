...
function fetchRecipes(searchQuery, resPP, offset) {
  return request
    .get(`https://api.spoonacular.com/recipes/search?query=${searchQuery}&number=${resPP}&apiKey=${process.env.API_KEY}&offset=${offset}`)
